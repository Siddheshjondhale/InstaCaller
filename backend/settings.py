...
SECRET_KEY = 'django-insecure-hu208=$qas*(z!k*a_bhn-t=))92p^wzux3b^cab86*nt*vsv#'
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            "sslmode": "allow",  # Allow for testing purposes; set to "disable" in production
        },
    }
}
...
CACHES = {
    "default": {
        ...
        "TIMEOUT": 300, # 5mins Cache timeout
    }
}
